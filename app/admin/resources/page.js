    ...
    <AdminShell>
      <h1 className="admin-heading">
        ...
        <AdminHelpIcon>
          ...
          <ul>
            <li><strong>Page to watch</strong> - the downloads or support page. Tick <em>Also look at pages on the same site</em> when the files sit one click deeper (a product page per model, say); it follows links on the same site, up to the Max pages you set (60 by default; a big document library may need more).</li>
