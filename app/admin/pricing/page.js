    ...
    <AdminShell>
      <h1 className="admin-heading">
        ...
        <AdminHelpIcon>
          ...
          <h4>Price list</h4>
          <p>Every active product with RRP, each tier&apos;s price (override first, tier default otherwise), cost where the feed carried one, and when it was last imported. Filter by supplier or search by SKU, name or category. Products come in through <strong>Businesses &amp; Suppliers</strong> → a supplier → <em>Import into store</em>.</p>
