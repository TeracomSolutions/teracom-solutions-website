...
export const metadata = pageMetadata({
  title: 'Teracom Store | Technology Products, Software & Resources',
  description:
    'Buy security and technology products, digital resources, training and Teracom AI subscriptions. CCTV, access control, intrusion and intercom hardware from leading brands. Australian owned, prices include GST.',
  path: '/store',
});
