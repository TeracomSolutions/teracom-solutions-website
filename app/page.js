...
const partnerLogos=[
  {name:'Genetec',file:'genetec.svg',width:101,height:19,boost:true,slug:'genetec'},
  {name:'Gallagher',file:'gallagher.png',width:608,height:258,slug:'gallagher'},
  {name:'Inner Range',file:'inner-range.png',width:1000,height:1000,caption:'Inner Range',slug:'inner-range'},
  {name:'Aritech',file:'aritech.png',width:674,height:180,slug:'aritech'},
  {name:'Milestone',file:'milestone.svg',width:1001,height:178,slug:'milestone'},
  {name:'HID',file:'hid.svg',width:94,height:38,boost:true,slug:'hid'},
  {name:'Axis Communications',file:'axis.svg',width:200,height:72,slug:'axis'},
];
const genericLogoTiles=[
  {name:'Networking',icon:'networking'},
  {name:'Cyber Security',icon:'cyber-security'},
];
