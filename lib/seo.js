...
export const BUSINESS = {
  ...
  postalCode: '3201',
  addressCountry: 'AU',
  // OFF DELIBERATELY (Robert, 2026-09-24): every contact route goes to email
  // until the phone system is decided. Putting the number back is these two
  // lines and nothing else -- every consumer checks for an empty value and
  // falls back to email, and the structured data omits the property rather
