...
export const BUSINESS = {
  ...
  accountsEmail: 'accounts@teracomsolutions.com.au',
  // Sourced from the showroom block in app/about/page.js -- "Weekdays: 8am --
  // 4:30pm / Weekend: Closed". Not invented; if the real hours change, that
  // page and this constant move together.
  openingHours: {
    days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    opens: '08:00',
    closes: '16:30',
  },
  // Matches the social links already rendered in components/Footer.js.
  sameAs: [
