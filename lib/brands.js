...
On the software side, installers can program a Challenger system on site or remotely over a modem or IP connection, and end users manage doors, alarms and video surveillance through Security Commander, including an interactive map of the building for quick operator control. The TecomPlus mobile app extends day-to-day control to a phone -- arming and disarming areas, opening doors, isolating inputs and checking input/relay status -- and the wider software suite provides integrated management across multiple systems from one place.`,
  ...
  },
  {
    slug: 'hikvision',
    name: 'Hikvision',
    tagline: 'One of the world\'s largest CCTV and video surveillance manufacturers.',
    body: `Hikvision is one of the world's largest manufacturers of CCTV and video surveillance equipment, with a product range spanning IP and analog cameras, NVRs and DVRs, and video management software used in installations from small offices through to large enterprise and city-scale surveillance networks. Hikvision's Hik-Connect cloud platform and mobile app are widely used for remote viewing, letting you check in on a site's cameras and recorders from a phone without complex network setup.

Hikvision also produces an IP video intercom range, released in 2017, designed for both residential and commercial installations. Beyond straightforward door access, these intercom systems support unit-to-unit video calling between rooms or buildings, so they can double as an internal communication system as well as an entry system. We supply and install a range of Hikvision cameras, recorders and intercoms as part of our CCTV offering.`,
    isOwnBrand: false,
    needsInput: true,
    logoFile: 'hikvision.svg',
  },
  {
    slug: 'honeywell',
    name: 'Honeywell',
...
The Tuxedo Touch controller extends a VISTA system into home and business automation. It's a 7-inch touchscreen that centralises control of the security system, video cameras and Z-Wave-enabled devices -- thermostats, lights, locks and shades -- from one interface, with voice commands for common actions like arming the system or adjusting the temperature when leaving or returning home. It also runs a built-in web server for local control from any Wi-Fi-enabled device, connects up to 32 IP cameras (viewing up to four at once on the display or remotely), and supports up to 30 customisable scenes that trigger based on time, day or system events.`,
  ...
  },
  {
    slug: 'd-link',
    name: 'D-Link',
    tagline: 'Over 30 years of Wi-Fi networking, routers and camera surveillance gear.',
    body: `D-Link has spent more than 30 years building a full line of Wi-Fi networking and camera surveillance products, from modem routers and range extenders through to managed switches and network cameras. Its router range covers everything from budget-friendly ADSL2+ and VDSL2 modem routers up to higher-end MU-MIMO AC models, giving a fit for a new NBN connection or an existing ADSL/cable service.

Beyond networking, D-Link's Connected Home range brings together networking, security and surveillance and home automation, aimed at self-installation without ongoing monthly fees. Its mobile broadband routers are built to be compact and portable -- some can even double as a USB charger -- for setting up a network on the move, and the mydlink SharePort app makes it straightforward to share pictures, music, video and files across a network.`,
    isOwnBrand: false,
    needsInput: false,
    logoFile: 'd-link.svg',
  },
...
The range includes both LCD and touchscreen keypads, with interactive emulators available to help installers and end users get familiar with the interface before it's on the wall. Visual verification -- linking video to an alarm event -- is treated as a core part of a modern installation rather than an add-on, letting a monitoring operator or end user confirm what actually triggered an alert rather than reacting to a signal alone.`,
  ...
  },
  {
    slug: 'sunfire',
    name: 'Sunfire',
    tagline: 'High-powered subwoofers and amplifiers known for compact, high-output designs.',
    body: `Sunfire is an audio brand best known for high-powered, compact subwoofers -- built on the idea, in the brand's own words, of "Little. Loud. Luxurious." Sunfire's amplifiers and subwoofers are aimed at listeners who want serious low-end performance without a subwoofer cabinet dominating the room. We can source Sunfire products as part of a home or commercial audio system.`,
    isOwnBrand: false,
    needsInput: true,
    logoFile: null,
  },
  {
    slug: 'niles',
    name: 'Niles',
    tagline: 'Multi-zone and in-wall speaker systems designed to blend into a home\'s architecture.',
    body: `Niles builds speakers, amplifiers and whole-home audio control systems designed to work with a home's architecture rather than sit as obvious equipment -- in-wall and in-ceiling speakers, outdoor speakers, and multi-zone systems that can extend to control lighting and climate alongside audio. The range covers indoor and outdoor locations with speakers optimised for each, plus speaker selectors and multi-channel digital amplifiers for distributing audio to multiple zones from a single rack.`,
    isOwnBrand: false,
    needsInput: false,
    logoFile: 'niles.png',
  },
