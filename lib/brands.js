...
Inner Range systems have been installed on more than 50,000 sites across 25 countries, backed by a global network of over 5,000 certified system integrators and more than 30 years in the field. The software is intuitive enough for non-security-expert users to operate day to day, from simple apps through to smartwatches, and an Integriti licence is a one-off purchase rather than an ongoing subscription -- unlike much of the enterprise access control market, there are no lock-in annual licence fees driving up the total cost of ownership over time.`,
    ...
    stats: [
      { value: '50,000+', label: 'Sites installed' },
      { value: '25', label: 'Countries' },
      { value: '5,000+', label: 'Certified integrators' },
      { value: '30+', label: 'Years in the field' },
    ],
    highlights: [
      { title: 'Unified by Design', body: "Access control and intrusion run as one system, not two -- extending through Integriti into CCTV, lighting, intercoms, HVAC and visitor management from a single interface." },
      { title: 'Multipath IP Monitoring', body: 'Encrypted IP and cellular paths to the monitoring centre, so critical alarm signals keep getting through even if one path fails.' },
      { title: 'No Lock-In Licensing', body: 'An Integriti licence is a one-off purchase, not an annual subscription -- unlike much of the enterprise access control market.' },
      { title: 'Built for Scale', body: 'From a single-door install to a multi-site global deployment, with software intuitive enough for non-expert operators day to day.' },
    ],
  },
  {
    slug: 'aritech',
