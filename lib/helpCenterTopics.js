...
If you're using port forwarding instead of the cloud: double-check the IP address and port in the address bar (it should read http://[external IP]:7000), try a different browser, and confirm ports 7000-7001 aren't blocked by any firewall, router port filtering or application exception list. Also check that the router's forwarding rule still points at the DVR's current local IP address, and that any Dynamic DNS hostname you're using hasn't expired.`,
  ...
  },
  {
    ...
    intro: `Checkout on the Teracom Store is handled entirely by Stripe, one of the world's largest payment processors -- we never see, handle or store your card details ourselves.`,
    faqs: [
      {
        q: 'What payment methods can I use?',
        a: "Checkout is processed securely by Stripe, which supports a range of payment methods depending on your card provider and location. See Stripe's own current list at https://stripe.com/au/payments/payment-methods for full details.",
      },
      {
        q: 'Is my payment information secure?',
        a: "Yes. You're redirected to Stripe to complete payment, and your card details are encrypted and processed directly by Stripe -- a PCI DSS Level 1 certified payment provider, the highest level of certification in the payments industry. Teracom never sees or stores your full card details.",
      },
    ],
  },
];
