...
export const publishedTermsVersions = [
  {
    ...
    sourceFile: 'Teracom Terms and Conditions v3.2.docx',
    contentHash: '94cfd3e0b503a2f87b0a3f6d04e9988fb9d6adbcbb3d5999b3601f8bb8634be9',
    ...
    // in place -- which is why v3.0, v3.1 and v3.2 could all be amended on
    // 23 September without breaking the rule. The moment it flips, the
    // wording is frozen and any further change is a new version.
    published: false,
    publishedAt: null,
