...
export const videos = [
  ...
  {
    title: 'How to Use BitVision for Teravision Recorder and IP Cameras',
    youtubeId: 'nVpe8Gt5OC4',
    description: 'Using the BitVision app to manage a Teravision recorder and IP cameras.',
    category: 'cctv',
  },
  {
    title: 'XMEye: Teravision App Registration and Setup',
    youtubeId: 'BzwhSyLlxwo',
    description: 'Registering and setting up the XMEye app on your mobile for Teravision devices.',
    category: 'cctv',
  },
];
