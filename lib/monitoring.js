...
export const monitoringFaqs = [
  ...
  },
  {
    ...
    answer:
      'Monitoring is charged at a fixed rate for the service you choose, payable monthly or quarterly in advance. Optional extras such as patrol attendance are charged only when used, and we will tell you the rate before doing chargeable work. Ask us for current rates.',
  },
  {
    question: 'How long am I committed for?',
    answer:
      'The initial term is 12 months from the day monitoring starts. After that it continues month to month unless you choose another fixed term, and you can cancel any time on 30 days notice. We write to you at least 30 days before each renewal telling you the date, the fees and how to cancel, and cancelling is no harder than signing up was.',
  },
  {
